    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">{t('login.title') || 'Log In'}</h1>
          <p className="text-gray-600 mt-2">{t('login.subtitle') || 'Welcome back to ExchangeHub'}</p>
        </div>
        <div className="bg-white p-8 rounded-xl shadow-sm space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? (t('login.loading') || 'Loading...') : (t('login.submit') || 'Log In')}
            </button>
          </form>
